...
import { 
  ...
  Heart, Share2, Phone, CheckCircle, Wifi, Home,
  Sparkles, Plus, Award, Map,
  X, Copy, Facebook, Twitter, Linkedin, MessageCircle
} from 'lucide-react';
...
const RestaurantPage = () => {
  ...
  const defaultInfo = {
    ...
    address: "Shop 9, Ground Floor, Hajipur Complex, Hajipur Road, Bihar",
    rating: "4.2",
  ...
  const restaurantInfo = {
    ...
    address: incomingData?.address || (incomingData?.cuisine ? `${incomingData.cuisine}, Hajipur` : defaultInfo.address),
  ...
  const menuItems = {
    Recommended: [
      { 
        ...
        price: "249", 
        desc: "Classic cheese pizza with basil and house sauce.", 
      ...
      { 
        ...
        price: "199", 
        desc: "Fresh greens with house dressing and olives.", 
      ...
      { 
        ...
        price: "459", 
        desc: "Spiced paneer, onion, capsicum and red paprika.", 
    ...
    Pizzas: [
      ...
      { 
        ...
        price: "549", 
        desc: "Loaded with double pepper barbecue chicken, peri-peri chicken.", 
    ...
    Beverages: [
      ...
      { 
        ...
        price: "149", 
        desc: "Thick shake with fresh strawberries.", 
    ...
    Desserts: [
      { 
        ...
        name: "Chocolate Cake", 
        price: "149", 
        desc: "Rich chocolate layer cake with ganache.", 
      ...
      { 
        ...
        price: "199", 
        desc: "Hot walnut brownie served with vanilla ice cream.", 
  ...
  const reviews = [
    { name: "Diner 38", rating: "4.4", date: "4 days ago", text: "Great food and ambiance! Highly recommended. (ID: 38)", initial: "D", color: "bg-purple-500" },
    ...
    { name: "Amit Kumar", rating: "5.0", date: "1 month ago", text: "Best pizza in Hajipur! The crust was perfect.", initial: "A", color: "bg-green-500" },
        ...
        <div className="absolute inset-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end pb-8">
          ...
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="text-white">
             ...
             <div className="flex items-center gap-3">
               ...
               {/* --- 1. RATING BADGE (Green, Rounded Box) --- */}
               ...
               {/* --- 2. TIME BADGE (Deep Orange, Pill Shape) --- */}
               ...
               {/* --- 3. COST BADGE (Purple, Pill Shape) --- */}
                  ...
                  <div className="mt-8">
                    ...
                    <div className="w-full h-72 bg-gray-200 rounded-2xl overflow-hidden shadow-sm border border-gray-100 relative group">
                      <iframe 
                        ...
                        frameBorder="0" 
                        scrolling="no" 
                        src={`http://googleusercontent.com/maps.google.com/maps?q=${encodeURIComponent(restaurantInfo.address)}&t=&z=15&ie=UTF8&iwloc=&output=embed`}
          ...
          {activeTab === 'Reviews' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
               <div className="flex items-center gap-3 mb-6">
                 ...
                 <span className="bg-[#E29826] text-white text-xs font-bold px-2 py-1 rounded shadow-sm">5 Reviews</span>
               </div>
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-4 mb-6">
                <a 
                  href={`https://wa.me/?text=${encodeURIComponent(`Check out ${restaurantInfo.name}! ${window.location.href}`)}`} 
                  target="_blank" rel="noreferrer"
                  className="flex flex-col items-center gap-2 group"
                >
                  <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
                ...
                <a 
                  ...
                  className="flex flex-col items-center gap-2 group"
                >
                  <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
                ...
                <a 
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Check out ${restaurantInfo.name}!`)}&url=${encodeURIComponent(window.location.href)}`} 
                  target="_blank" rel="noreferrer"
                  className="flex flex-col items-center gap-2 group"
                >
                  <div className="w-12 h-12 bg-sky-500 rounded-full flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
                ...
                <a 
                  ...
                  className="flex flex-col items-center gap-2 group"
                >
                  <div className="w-12 h-12 bg-blue-700 rounded-full flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
              ...
              <div className="flex items-center gap-2 bg-gray-100 p-3 rounded-xl border border-gray-200">
                ...
                <button 
                  ...
                  className="bg-white text-gray-700 px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm hover:bg-gray-50 border border-gray-200 flex items-center gap-1"
                >
